...
<html>
	...
	<div class="div1" ><form method="post" enctype="multipart/form-data" action="addproductnw.php"><table align="center" cellpadding=10>
			<tr><td><br></td></tr>
					...
					<tr><td>product_keywords</td><td><input type="text" name="product_keywords"></td></tr><br>
					<tr><td><br></td></tr>
					<tr><td colspan=2 align="center"><input type="submit" name="submit" bckground-color="grey" color="white"></td></tr>
